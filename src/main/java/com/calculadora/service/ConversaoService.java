...
public interface ConversaoService {
	...
	public BigDecimal converterMoeda(BigDecimal valor, String firstMoeda, String moedaResultante) throws NumberFormatException, MalformedURLException, IOException, ImpossivelConverterException, ConnectException;
}
